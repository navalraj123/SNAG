...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="img/log2.jpg">

    <title>Login | Snag</title>
  ...
  <body>
      <a style="color:#ffffff;background-color:transparent;top-margin:auto;" href="../indexr.php">Back to Home</a>
      <body style="background-image:url(img/a7.jpg)">
    ...
    <div class="container">
      ...
      <form class="form-signin animated shake" action="" method="post">
          <br><br>
        <h2 class="form-signin-heading">SNAG Login</h2>
          <br>
