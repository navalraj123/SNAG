    ...
    <div class="jumbotron">
        <div class="container">
            <div id="details" class="animated fadeInLeft">
                <h1>SNAG <span>Creations</span></h1>
                <p>This is the official ERP Portal, So stay connected...</p>
            </div>
        </div>
        <img src="img/a1.jpg" alt="Top Image">
    </div>
                      ...
                      <ul class="pagination">
                        <?php
                          for($i = 1; $i <= $total_pages; $i++){
                              echo "<li class='".($page_id == $i ? 'active': ' ')."'><a href='indexr.php?page=".$i."&".(isset($cat_name)?"cat=$cat_id":" ")."'>$i</a></li>";
                          }
                          ?>
                      </ul>
                    </nav>
