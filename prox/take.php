...
<html>
 ...
 <body>
  ...
  <div class="container"> 
    ...
    ?>
    <div id="studentRecords" style="color:#ffffff;">
    <?php
      foreach($records as $roll => $data) {
        echo '<div class="student-record" style="color:#ffffff;">
          <span class="roll" style="color:#ffffff;"><a href="student.php?roll='.str_replace("/","-",$roll).'&code='.$node->getCode().'&year='.$node->getYear().'&section='.$node->getSection().'">'.$roll.'</a></span>: 
